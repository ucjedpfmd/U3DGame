namespace com.net
{
	class SocketCommand
	{
        ...
        public static string MONSTER_ATTR_CHANGE = "MONSTER_ATTR_CHANGE";
        public static string MONSTER_WALK_PATH = "MONSTER_WALK_PATH";
        public static string MONSTER_WALK = "MONSTER_WALK";
        public static string MONSTER_SUMMON = "MONSTER_SUMMON";
